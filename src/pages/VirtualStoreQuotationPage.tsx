...
import { FileText, Presentation, Loader2, Lightbulb, Zap, Box, Palette, Clock, Settings, RefreshCw, LifeBuoy, Info, Check, Mail, Phone, ShoppingBag } from 'lucide-react';
import html2pdf from 'html2pdf.js';
import pptxgen from 'pptxgenjs';
import html2canvas from 'html2canvas';

export default function VirtualStoreQuotationPage() {
  ...
  const handleExportPDF = async () => {
    ...
    const opt: any = {
      margin: [10, 0, 10, 0],
      filename: 'Propuesta_KODO_Tienda_Virtual.pdf',
  ...
  const handleExportPPTX = async () => {
    ...
    try {
      ...
      await pres.writeFile({ fileName: 'Propuesta_KODO_Tienda_Virtual.pptx' });
    } catch (error) {
            ...
            <div className="export-section">
              <header className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-[#f3f4f6] pb-10 mb-10">
                ...
                <div className="text-left md:text-right bg-[#f0f7f8] p-4 rounded-xl">
                  ...
                  <p className="text-xl font-bold text-[#111827]">Tienda Virtual</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
                <div>
                  ...
                  <p className="text-[#4b5563] leading-relaxed mb-4 text-sm">
                    En KODO, el enfoque no es solo desarrollar una página web, sino crear una herramienta digital que permita mostrar correctamente los productos y facilitar la generación de ventas.
                  </p>
                  <p className="text-[#4b5563] leading-relaxed text-sm">
                    Para este proyecto, se propone una solución simple, funcional y escalable que permita al negocio comenzar su presencia online sin complejidad innecesaria.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-[#4b5563] leading-relaxed text-sm mb-4 italic">
                    Desarrollar una tienda virtual básica que permita:
                  </p>
                  <div className="grid grid-cols-1 gap-2 mt-4">
                    {[
                      'Mostrar productos de forma clara y atractiva',
                      'Alcanzar clientes a nivel nacional',
                      'Facilitar el contacto directo vía WhatsApp',
                      'Permitir una gestión sencilla de contenido'
                    ].map((text, idx) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
                <div className="bg-[#0a363e] text-[#ffffff] rounded-2xl p-8 relative overflow-hidden shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1),0_4px_6px_-2px_rgba(0,0,0,0.05)]">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {['Inicio', 'Productos (catálogo)', 'Sobre el negocio', 'Contacto'].map(s => (
                    ...
                    <ul className="grid grid-cols-1 gap-1.5 text-xs text-[#e5e7eb]">
                      ...
                      <li className="flex items-center gap-2">✔ Catálogo de productos autogestionable</li>
                      <li className="flex items-start gap-2">
                        <span>✔ Fichas de producto con:</span>
                      </li>
                      <li className="ml-6 flex flex-col gap-1 opacity-80">
                        <span>• Imágenes y Video (opcional)</span>
                        <span>• Características principales</span>
                        <span>• Precio</span>
                      </li>
                      <li className="flex items-center gap-2">✔ Botón de contacto vía WhatsApp por producto</li>
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <p className="text-xs text-[#6b7280] mb-4 italic">El diseño estará enfocado en:</p>
                    <ul className="mt-3 space-y-3 text-sm text-[#4b5563]">
                      {[
                        'Claridad y facilidad de navegación',
                        'Enfoque en el producto (imágenes y precios visibles)',
                  ...
                  <div className="bg-[#fefce8] border border-[#fef9c3] p-5 rounded-xl">
                    ...
                    <p className="text-2xl font-bold text-[#125b69] mb-1">2 a 3 semanas</p>
                    <p className="text-xs text-[#6b7280] italic">* Tiempo estimado para una solución ágil y funcional.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  {[
                    ...
                    { n: 2, t: 'Estructura', d: 'Definición de navegación.' },
                    { n: 3, t: 'Diseño', d: 'Propuesta visual KODO.' },
                    { n: 4, t: 'Desarrollo', d: 'Implementación técnica.' },
                    { n: 5, t: 'Carga', d: 'Carga inicial de productos.' },
                    { n: 6, t: 'Revisión', d: 'Ajustes finales.' },
                    { n: 7, t: 'Entrega', d: 'Publicación de la tienda.' }
                  ].map(step => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div className="bg-[#f9fafb] p-6 rounded-2xl border border-[#f3f4f6]">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#4b5563]">Cambios estructurales posteriores a la aprobación del diseño.</p>
                  </div>
                </div>
                ...
                <div className="bg-[#f9fafb] p-6 rounded-2xl border border-[#f3f4f6]">
                  ...
                  <div>
                    <span className="inline-block bg-[#f3f4f6] text-[#374151] text-xs px-2 py-1 rounded font-bold mb-2 uppercase">Detalles:</span>
                    <p className="text-sm text-[#4b5563]">Correcciones menores y asistencia técnica básica.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="export-section pt-8">
              <div className="mb-12">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-[#111827]">9. Mantenimiento Mensual (Opcional)</h2>
                </div>
                <p className="text-sm text-[#4b5563] leading-relaxed mb-8">
                  Para mantener la tienda actualizada, funcional y optimizada en el tiempo, se ofrece un servicio de mantenimiento mensual.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
                  <div className="bg-[#f9fafb] p-6 rounded-2xl border border-[#f3f4f6]">
                    ...
                    <ul className="space-y-2 text-xs text-[#4b5563]">
                      ...
                      <li>• Revisión técnica general</li>
                  ...
                  <div className="bg-[#f9fafb] p-6 rounded-2xl border border-[#f3f4f6]">
                    <h3 className="text-[#f1b51c] font-bold text-sm mb-4 uppercase tracking-wider flex items-center gap-2">
                      ➕ Cambios en productos:
                    </h3>
                    <ul className="space-y-2 text-xs text-[#4b5563]">
                      <li>• Actualización de precios</li>
                      <li>• Cambio de imágenes</li>
                      <li>• Carga de nuevos productos (limitado)</li>
                    </ul>
                  </div>
                </div>

                <div className="bg-[#0a363e] rounded-2xl p-8 text-center text-[#ffffff] shadow-lg relative overflow-hidden mb-12">
              ...
              <div className="bg-[#ffffff] border-2 border-[#125b69] rounded-2xl overflow-hidden mb-12 shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1),0_10px_10px_-5px_rgba(0,0,0,0.04)] relative">
                <div className="absolute top-0 right-0 bg-[#f1b51c] text-[#ffffff] text-xs font-bold px-4 py-1 rounded-bl-lg">OFERTA LANZAMIENTO</div>
                <div className="p-8 md:p-10 text-center">
                  <h2 className="text-2xl font-bold text-[#111827] mb-2">10. Inversión del Proyecto</h2>
                  <p className="text-xs text-[#6b7280] mb-8 italic">Desarrollo de plataforma E-commerce básica autogestionable.</p>
                  ...
                  <div className="flex flex-col md:flex-row justify-center items-center gap-12 mb-8">
                    <div className="text-[#125b69] transform scale-110 flex flex-col items-center">
                      <p className="text-[10px] uppercase tracking-widest font-bold text-[#125b69] mb-1">Inversión</p>
                      <div className="flex items-baseline gap-2">
                        <p className="text-4xl font-extrabold text-[#0a363e]">1800</p>
            ...
            <div className="export-section pt-8">
              <div className="border-t border-[#f3f4f6] pt-8">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 text-xs text-[#4b5563]">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-[#125b69] font-bold">•</span>
                    El alcance corresponde a una tienda básica sin sistema de pagos integrado.
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#125b69] font-bold">•</span>
